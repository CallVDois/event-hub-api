package com.callv2.eventhub.infrastructure.event.adapter;

import java.util.Set;
import java.util.stream.Collectors;

import com.callv2.eventhub.application.event.register.RegisterEventInput;
import com.callv2.eventhub.application.event.retrieve.get.GetEventInput;
